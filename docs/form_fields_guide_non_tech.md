...
| **ATO Debts, Audits & Disputes** (`atoIssues`, `atoExplanation`, `noticeDate`, `dueDate`)                            | Tells us if you have overdue ATO debts, active audits, or payment arrangements.         | Enables us to request ATO debt pauses or payment plans on your behalf.                    | ⚠️ **+3 Risk Points** _(Triggers Tax Agent manual review)_ |
...
_(Only active if Sole Trader BAS, ABN, or GST was selected in Step 1)_
...
_Document Version:_ `v1.1.0` (Non-Technical Client Edition)  
_Published By:_ Financially Up Compliance & Tax Advisory Team  
_Reference Standard:_ TPB Identity Guidelines | TASA 2009 | ETA 1999 | Privacy Act 1988
